...
N_PATIENTS <- 250
R <- 320 # Reduced for vignette build time; use higher (e.g., 1000) for analysis
SEED <- 2375678
FU <- 60
...
```{r}
p1 <- plot_bootstrap_sops(bs_simple, title = "Model A: Simple PO") + 
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  coord_cartesian(ylim = c(0, 1))

p2 <- plot_bootstrap_sops(bs_inter, title = "Model B: PO + Interaction") + 
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  coord_cartesian(ylim = c(0, 1))

p3 <- plot_bootstrap_sops(bs_flex, title = "Model C: Partial PO + Interactions") + 
  scale_fill_brewer(palette = "Dark2") +
  scale_color_brewer(palette = "Dark2") +
  coord_cartesian(ylim = c(0, 1))
